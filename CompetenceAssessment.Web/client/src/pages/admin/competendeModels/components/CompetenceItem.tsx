...
export const CompetenceItem: React.FC<CompetenceItemProps> = ({
                                                                  modelId,
                                                                  competenceId,
                                                                  name,
                                                                  description,
    ...
    const handleWeightChange = (value: string) => {
        ...
        setError('');
        onWeightChange(competenceId, num)
    };
    ...
    return (
        <div style={{
            ...
            <div style={{ flex: 2 }}>
                ...
                {description && (
                    <div style={{ fontSize: '0.75rem', color: '#6f6f6f' }}>{description}</div>
                )}
            </div>

            <div style={{ width: '120px' }}>
                <TextInput
                    id={`weight-${competenceId}`}
                    labelText="Вес"
                    value={weightValue}
