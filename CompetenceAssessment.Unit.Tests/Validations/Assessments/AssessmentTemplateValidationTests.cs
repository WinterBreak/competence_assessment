...
public class AssessmentTemplateValidationTests
{
    private readonly AssessmentTemplateValidation _rule = new();

    [Fact]
    public async Task Validate_Should_Add_Error_When_Template_Id_Is_Null()
    {
    ...
    [Fact]
    public async Task Validate_Should_Not_Add_Error_When_Template_Id_Is_Set()
    {
        var errors = new ValidationErrors();
